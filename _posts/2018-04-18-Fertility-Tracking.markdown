...
So our approach to tackle this problem is to provide the user customizable graphs in which they can remove or add indicators that they want to track. Since people with different goals have different needs, they want to see, analyze and compare different things. For example, people who are TTC want to see their BBT, or people who track their period may want to monitor their sleep duration and cramps. Or there're some people just want to track their migraine and see how it changes throughout their cycles.<br>
