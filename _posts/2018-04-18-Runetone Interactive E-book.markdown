...
If we had more time, we could implement new changes in the user interface. Then, test the changes by doing more usability testing on the new design. We could have participants complete the same tasks as the participants in this usability test to compare and contrast the data using the current e-book and the updated e-book. <br><br>