---
layout: post
title:  "Real Play - <br>Conceptual Project"
date:   2018-04-18 15:39:40
preview: /img/Paciolan/thumbnail.jpg
...
<br>**Note**: 
- A child’s profile page is the same as the parents except there is not a list of children and there is not “friends bar”.
- There is not an option to search new groups. You must know someone in the group to get added which improves the safety of RealPlay.
- Child responding to event notifies parents.
- Children cannot create groups<br>

**TEAM** <br>
><br>**Kevin Florio, Thu Huynh, Janice Hsu, Matthew Herrera, Ashton Garcia**<br><br>

|    My Roles    | Duration |    Tool     |
| :------------: | :------: | :---------: |
| UI/UX Designer | 1 month  |    Figma    |
