...
Use Case Diagram<br>
<img src="/img/Paciolan/useCase.jpg" height="600"/> <br>
Figure 1.1. Use-Case Diagram for SDM Web App’s Corporate Site.

USE CASE  1   Conduct freeform search in the SDM
Priority: MUST HAVE
...
USE CASE  3   Save changes to the metadata database
Priority: MUST HAVE
...
USE CASE  4  Users should be able to enable integration for each of the events, (SMS, check-in, NFC)
Priority: MUST HAVE
...
<br>
**UI DESIGN**<br>
<img src="/img/Paciolan/search.png" height="600"/> <br>
