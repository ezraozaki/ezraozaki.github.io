...
Below are selected screens from the redesigned mobile experience, showcasing how complex case data and actions were adapted for smaller devices while maintaining clarity, accessibility, and consistency with the desktop portal.
